...
import {
  ...
  GROUP_TOP_CONSTRUCTIVE,
  GROUP_TOP_END_UNITS,
  GROUP_TOP_NORMAL_UNITS,
  GROUP_TOP_VITRINA_UNITS,
  GROUP_UTILITIES,
} from '../constants';
import {ConstructiveBuilderService} from './constructive-builder.service';
...
export class UnitBuilderService {
  ...
  private readonly constructive = inject(ConstructiveBuilderService);
  ...
  constructor() {
    this.strategyMap = {
      ...
      [GROUP_UTILITIES]: this.constructive,
