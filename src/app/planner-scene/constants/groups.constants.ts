...
export const GROUP_TOP_VITRINA_UNITS = 'topVitrinaUnits';
...
export const GROUP_DOBORY      = 'dobory';
...
export const GROUP_BOTTOM_CONSTRUCTIVE = 'bottomConstructive';
export const GROUP_UNITS             = 'units';
